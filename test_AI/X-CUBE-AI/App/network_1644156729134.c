/**
  ******************************************************************************
  * @file    network_1644156729134.c
  * @author  AST Embedded Analytics Research Platform
  * @date    Sun Feb  6 22:51:58 2022
...
#include "network_1644156729134.h"
#include "network_1644156729134_data.h"
...
#define AI_NET_OBJ_INSTANCE g_network_1644156729134
 
#undef AI_NETWORK_1644156729134_MODEL_SIGNATURE
#define AI_NETWORK_1644156729134_MODEL_SIGNATURE     "1f2fa0f4c57199d3637ed2791f12fd0b"
...
#define AI_TOOLS_DATE_TIME   "Sun Feb  6 22:51:58 2022"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_NETWORK_1644156729134_N_BATCHES
#define AI_NETWORK_1644156729134_N_BATCHES         (1)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  12, 0x0,
  AI_SHAPE_INIT(4, 9216, 128, 1, 1), AI_STRIDE_INIT(4, 1, 4608, 589824, 589824),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  16, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 24, 2), AI_STRIDE_INIT(4, 4, 4, 256, 6144),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 670824, 1, 1),
    670824, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 102144, 1, 1),
    102144, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1644156729134_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1644156729134_OUT_NUM, &dense_2_output),
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool network_1644156729134_configure_activations(
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    conv2d_1_conv2d_output_array.data = AI_PTR(activations_map[0] + 3328);
    conv2d_1_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 3328);
    conv2d_2_conv2d_scratch0_array.data = AI_PTR(activations_map[0] + 89856);
    conv2d_2_conv2d_scratch0_array.data_start = AI_PTR(activations_map[0] + 89856);
    ...
    dense_1_dense_output_array.data = AI_PTR(activations_map[0] + 36864);
    dense_1_dense_output_array.data_start = AI_PTR(activations_map[0] + 36864);
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool network_1644156729134_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    conv2d_1_conv2d_bias_array.data = AI_PTR(weights_map[0] + 1152);
    conv2d_1_conv2d_bias_array.data_start = AI_PTR(weights_map[0] + 1152);
    conv2d_2_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_conv2d_weights_array.data = AI_PTR(weights_map[0] + 1280);
    conv2d_2_conv2d_weights_array.data_start = AI_PTR(weights_map[0] + 1280);
    conv2d_2_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_conv2d_bias_array.data = AI_PTR(weights_map[0] + 75008);
    conv2d_2_conv2d_bias_array.data_start = AI_PTR(weights_map[0] + 75008);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(weights_map[0] + 75328);
    dense_1_dense_weights_array.data_start = AI_PTR(weights_map[0] + 75264);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(weights_map[0] + 665152);
    dense_1_dense_bias_array.data_start = AI_PTR(weights_map[0] + 665152);
    dense_2_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_weights_array.data = AI_PTR(weights_map[0] + 665664);
    dense_2_dense_weights_array.data_start = AI_PTR(weights_map[0] + 665664);
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(weights_map[0] + 670784);
    dense_2_dense_bias_array.data_start = AI_PTR(weights_map[0] + 670784);
    return true;
  }
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_network_1644156729134_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_NETWORK_1644156729134_MODEL_NAME,
      .model_signature   = AI_NETWORK_1644156729134_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_bool ai_network_1644156729134_get_report(
  ai_handle network, ai_network_report* report)
{
  ai_network* net_ctx = AI_NETWORK_ACQUIRE_CTX(network);
...
AI_API_ENTRY
ai_error ai_network_1644156729134_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_network_1644156729134_create(
...
AI_API_ENTRY
ai_error ai_network_1644156729134_create_and_init(
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
    ai_error err;
    ai_network_params params;

    err = ai_network_1644156729134_create(network, AI_NETWORK_1644156729134_DATA_CONFIG);
    if (err.type != AI_ERROR_NONE)
        return err;
    if (ai_network_1644156729134_data_params_get(&params) != true) {
        err = ai_network_1644156729134_get_error(*network);
        return err;
    }
#if defined(AI_NETWORK_1644156729134_DATA_ACTIVATIONS_COUNT)
    if (activations) {
...
#endif
#if defined(AI_NETWORK_1644156729134_DATA_WEIGHTS_COUNT)
    if (weights) {
...
#endif
    if (ai_network_1644156729134_init(*network, &params) != true) {
        err = ai_network_1644156729134_get_error(*network);
    }
    return err;
}
...
AI_API_ENTRY
ai_buffer* ai_network_1644156729134_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_network_1644156729134_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    ((ai_network *)network)->magic = AI_MAGIC_CONTEXT_TOKEN;
...
AI_API_ENTRY
ai_handle ai_network_1644156729134_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_network_1644156729134_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= network_1644156729134_configure_weights(net_ctx, params);
  ok &= network_1644156729134_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_network_1644156729134_run(
...
AI_API_ENTRY
ai_i32 ai_network_1644156729134_forward(ai_handle network, const ai_buffer* input)
{
