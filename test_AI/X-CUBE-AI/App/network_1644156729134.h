...
#ifndef AI_NETWORK_1644156729134_H
#define AI_NETWORK_1644156729134_H
#pragma once

#include "network_1644156729134_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_1644156729134_MODEL_NAME          "network_1644156729134"
#define AI_NETWORK_1644156729134_ORIGIN_MODEL_NAME   "mnist_cnn"

/******************************************************************************/
#define AI_NETWORK_1644156729134_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_NETWORK_1644156729134_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_1644156729134_IN \
  ai_network_1644156729134_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1644156729134_IN_SIZE { \
  AI_NETWORK_1644156729134_IN_1_SIZE, \
}
#define AI_NETWORK_1644156729134_IN_SIZE_BYTES { \
  AI_NETWORK_1644156729134_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_1644156729134_IN_1_HEIGHT      (28)
#define AI_NETWORK_1644156729134_IN_1_WIDTH       (28)
#define AI_NETWORK_1644156729134_IN_1_CHANNEL     (1)
#define AI_NETWORK_1644156729134_IN_1_SIZE        (28 * 28 * 1)
#define AI_NETWORK_1644156729134_IN_1_SIZE_BYTES  (3136)

/******************************************************************************/
#define AI_NETWORK_1644156729134_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_1644156729134_OUT \
  ai_network_1644156729134_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1644156729134_OUT_SIZE { \
  AI_NETWORK_1644156729134_OUT_1_SIZE, \
}
#define AI_NETWORK_1644156729134_OUT_SIZE_BYTES { \
  AI_NETWORK_1644156729134_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_1644156729134_OUT_1_CHANNEL     (10)
#define AI_NETWORK_1644156729134_OUT_1_SIZE        (10)
#define AI_NETWORK_1644156729134_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_NETWORK_1644156729134_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_1644156729134
 ...
 * @ref ai_network_1644156729134_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_1644156729134_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1644156729134_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1644156729134_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_1644156729134_*
 * defines into file @ref network_1644156729134.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_1644156729134_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_1644156729134_H */
